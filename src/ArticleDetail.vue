...
<!--        帖子标题-->
        <div class="headOfArticle">
            ...
            <div style="flex: 8">
                ...
                <div style="flex: 1">
                    <el-button   v-if="!showSign"  type="primary" round @click="collectArticle">收藏帖子</el-button>
...
<!--            帖子所属专题或者标签-->
            <div class="tip">
                ...
                <div class="classification" style="flex: 1;display: flex">
                    帖子标签:<span style="align-items: center;flex: 1;margin-left: 10px;"><i style="background-color: rgba(64,158,255,0.2);padding: 0 10px;border-radius: 5px">{{article.type}}</i></span>
                </div>
            </div>
        </div>
<!--        帖子主体内容-->
