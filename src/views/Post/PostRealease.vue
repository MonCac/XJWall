    ...
    <div style="position: sticky;top:0px;z-index: 999">
        <div style="height: 60px;background-color: rgb(251,251,251);">
            <div class="PersonalCenter">
                <a href="/front/editMaterial/ArticleCommand" > <i class="el-icon-arrow-left"></i> 帖子管理</a>
            </div>
            <div class="title">
...
<!--                      slot="reference"-->
                    ...
                    <el-button type="primary" style="width: 100px;height: 40px;border-radius: 23px;font-size: 14px;margin-left: 10px"  @click="handleEdit"><i class="el-icon-position" ></i> 发布帖子</el-button>
            </div>
    ...
    <div style="width: 100%;height: 100%;">
        ...
        <el-dialog title="帖子信息" :visible.sync="dialogFormVisible" width="30%" fullscreen="true">
