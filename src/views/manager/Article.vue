<template>
    <div>
        <div style="padding: 5px 0;">
            <el-input style="width: 200px" placeholder="请输入帖子名称" suffix-icon="el-icon-search" v-model="name"></el-input>
        ...
        <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">>
            ...
            <el-table-column prop="name" label="帖子标题" width="100" align="center"></el-table-column>
            <el-table-column prop="summary" label="帖子概述" width="100" align="center"></el-table-column>
            <el-table-column prop="content" label="帖子内容" width="200" align="center">
...
<!-- 编辑的弹窗-->
        <el-dialog title="帖子信息" :visible.sync="dialogFormVisible" width="100%" fullscreen="true">
            <el-form label-width="80px"   ref="form" :model="form">
                <el-form-item label="帖子标题" >
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="帖子概述" >
        ...
        <el-dialog title="帖子预览" :visible.sync="viewDialogVis" width="60%" >
          <el-card>
              <div>
                  <mavon-editor
                          class="md"
